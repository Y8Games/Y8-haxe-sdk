...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Y8Test", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Y8Test", null, 1360, 768);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "37";
		app.meta["company"] = "Y8";
		app.meta["file"] = "Y8Test";
		app.meta["name"] = "Y8 SDK Haxe Test";
		app.meta["packageName"] = "com.y8.haxetest";
		...
		#elseif air
		app.window.title = "Y8 SDK Haxe Test";
		#else
